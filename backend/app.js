...
app.use(express.json()); // pour pouvoir gérer le corps d'une requête json
...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', '*'); // *= depuis n'importe quelle origine (pour éviter les CORS)
